...
passthrough_whitelist={"devname":"PF1",
...
- nova.scheduler.filter_scheduler.FilterScheduler._schedule
  - chosen_host.obj.consume_from_request(spec_obj)
    - nova.pci.stats.PciDeviceStats.apply_requests

https://github.com/openstack/nova/blob/73887d96810bf9703695d52c9f7df18bc6c29285/nova/pci/stats.py#L282

Ideas:
- if hint: go through pools and get all tags
  then update pci_request with appropriate tags
...
Two new virtual pci devices were added:

#+BEGIN_SRC text
    <interface type='network'>
      <mac address='52:54:00:a5:fe:4a'/>
      <source network='default' bridge='virbr0'/>
      <target dev='vnet2'/>
      <model type='virtio'/>
      <alias name='net1'/>
...
[pci]
passthrough_whitelist = {"address": "00:09.0", "switch": "sw1", "networkgroup":"ng1"}
passthrough_whitelist = {"address": "00:0a.0", "switch": "sw2", "networkgroup":"ng2"}
alias = {"name": "network", "product_id": "1000", "vendor_id": "1af4", "device_type": "type-PCI" }

On scheduler:
<nova.pci.stats.PciDeviceStats object at 0x7fc0e61f78d0>
ipdb> self.pci_stats.pools
[{'count': 1, 'product_id': u'1000', u'dev_type': u'type-PCI', 'numa_node': None, 'vendor_id': u'1af4', u'switch': u'sw1', u'physical_network': u'physnet1'}, {'count': 1, 'product_id': u'100
0', u'dev_type': u'type-PCI', 'numa_node': None, 'vendor_id': u'1af4', u'switch': u'sw2', u'physical_network': u'physnet2'}]
...
openstack server create --flavor pci_network --image cirros-0.3.5-x86_64-uec $(rname.sh)
